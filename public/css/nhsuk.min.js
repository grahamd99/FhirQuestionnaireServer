(() => {
  ...
  function h(e) {
    var t = i[e];
    return (
      void 0 !== t || ((t = i[e] = { exports: {} }), n[e](t, t.exports, h)),
      t.exports
    );
  }
  (() => {
    ...
    var f = (function () {
      function t(e) {
        ...
        r(this, "KEY_SPACE", 32),
          r(this, "DEBOUNCE_TIMEOUT_IN_SECONDS", 1),
          (this.$module = e),
      ...
      for (
          ...
          i = [
            ...
            },
            {
              ...
              value: function (e) {
                var t = this;
                if (
                  "true" === e.target.getAttribute("data-prevent-double-click")
                )
        ...
        (o.enumerable = o.enumerable || !1),
          ...
          Object.defineProperty(n, s(o.key), o);
      }
        ...
        },
        {
          ...
          value: function () {
            ...
            return (
              t.maxwords && (n = "word"),
              (n += -1 == e || 1 == e ? "" : "s"),
              (t = e < 0 ? "too many" : "remaining"),
              (e = Math.abs(e)),
              "You have ".concat(e, " ").concat(n, " ").concat(t)
            );
          },
        },
        {
    ...
    function a(e) {
      if (!(this instanceof a))
        throw new TypeError("Cannot call a class as a function");
      (this.$module = e),
        (this.$textarea = e.querySelector(".nhsuk-js-character-count")),
    ...
    function m(e, t) {
      ...
      e &&
        t &&
        ((n = "true" === e.getAttribute(t) ? "false" : "true"),
        e.setAttribute(t, n));
    }
    function y(e, t) {
      var n;
      e &&
        ...
        (e.checked
          ? (n.classList.remove(t), e.setAttribute("aria-expanded", !0))
          : (n.classList.add(t), e.setAttribute("aria-expanded", !1)));
    }
    function p(e) {
                ...
                if (t) {
                  ...
                  if (t.length) {
                    ...
                    if (
                      i.height &&
                      window.innerHeight &&
                      i.top + i.height - n < window.innerHeight / 2
                    )
                      return t;
                  }
                }
      ...
      t((i = l).prototype, [
        ...
        },
        {
          ...
          value: function (e) {
            var t = l.getHref(e).slice(1),
              t =
                (e.setAttribute("id", "tab_".concat(t)),
        ...
        },
        {
          ...
          value: function (e) {
            var t, n;
            this.historyEnabled &&
              ((n = (t = this.getPanel(e)).id),
              (t.id = ""),
              (this.changingHash = !0),
              (window.location.hash = l.getHref(e).slice(1)),
              (t.id = n));
          },
        },
        {
        ...
        },
        {
          ...
          value: function () {
            ...
            (e = n
              ? n.querySelector(".".concat(this.namespace, "__tab"))
              : e) &&
              (this.hideTab(t),
              this.showTab(e),
              e.focus(),
        ...
        },
        {
          ...
          value: function (e) {
            e = this.getPanel(e);
            e.classList.remove(this.jsHiddenClass),
              e.dispatchEvent(this.showEvent);
          },
        },
        {
          key: "hidePanel",
          value: function (e) {
            ...
            e.classList.add(this.jsHiddenClass),
              e.dispatchEvent(this.hideEvent);
          },
        },
        {
          key: "unhighlightTab",
                ...
                : ((n = e.target).form
                    .querySelectorAll(
                      'input[type="checkbox"][data-checkbox-exclusive][data-checkbox-exclusive-group="'.concat(
                        n.getAttribute("data-checkbox-exclusive-group"),
                        '"]'
                      )
                    )
                    .forEach(function (e) {
            ...
            c.forEach(function (e, t) {
              ...
              e.hasAttribute("nhsuk-polyfilled") ||
                ...
                (i = document.querySelector(
                  "#".concat(n.id, " .nhsuk-details__text")
                )).id || i.setAttribute("id", "nhsuk-details__text".concat(t)),
                (a = document.querySelector(
                  "#".concat(n.id, " .nhsuk-details__summary")
                ...
                a.addEventListener("click", function () {
                  m(a, "aria-expanded"),
                    m(i, "aria-hidden"),
                    (i.style.display =
                      "true" === i.getAttribute("aria-hidden") ? "none" : ""),
                    n.hasAttribute("open")
